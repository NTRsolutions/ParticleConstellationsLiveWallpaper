...
public class GlParticlesView implements IParticlesView {
    ...
    private int lineCoordinatesCapacity(final int segmentsCount) {
        return segmentsCount * VERTICES_PER_LINE * COORDINATES_PER_VERTEX * BYTES_PER_SHORT;
    }
